...
<template>
  <div>
    ...
    <section class="mx-auto max-w-6xl space-y-20 px-6 pb-28">
      <article
      ...
      >
        ...
        >
          ...
          />
          <span
            class="relative grid h-24 w-24 place-items-center rounded-3xl bg-gradient-to-br text-white shadow-2xl"
            :class="feature.accent"
          >
